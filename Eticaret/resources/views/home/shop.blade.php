                                ...
                                <div class="list-group-collapse sub-men">
                                    ...
                                    <div class="collapse show" id="sub-men1" data-parent="#list-group-men">
                                        ...
                                        @foreach($category as $cat)
                                            <a href="/{{$cat->id}}/kategoriler" class="list-group-item list-group-item-action ">{{$cat->title}}</a>
                                            ...
                                            <div class="col-sm-6 col-md-6 col-lg-8 col-xl-8">
                                                <div class="why-text full-width">
                                                    ...
                                                    <form action="{{ route('shopcart-store',['id'=>$urun->id]) }}" method="post">
                                                            @csrf 
                                                            <input type="hidden" name="product_quantity" value="1">
                                                            <button class="btn btn-danger" type="submit" onclick="Swal.fire({ icon: 'success', title: 'Ürün sepetinize eklendi!', showConfirmButton: false, timer: 1500})" >Add to Cart</button>
                                                    </form>
                                                </div>
                                            </div>
                                        </div>
